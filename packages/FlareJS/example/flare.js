  ...
  async reconstructDOM({ type: e, next: t, prev: n, scrollId: r }) {
    ...
    try {
      if (this.log("\u26A1", e), ["popstate", "link", "go"].includes(e) && t !== n) {
        ...
        }).then((a) => new Response(a, { headers: { "Content-Type": "text/html" } }))).text(), c = x(i);
        L(c), this.opts.pageTransitions && document.createDocumentTransition ? document.createDocumentTransition().start(() => {
          g(c), b(), m(e, r);
